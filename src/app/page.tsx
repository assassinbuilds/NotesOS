      ...
      <section className="relative w-full mt-0 mb-8 rounded-b-[50px] bg-gradient-to-b from-[#4fa5e8] via-[#70b7f0] to-[#99c8f2] text-white shadow-2xl shadow-blue-900/10">
        ...
        <div className="mx-auto max-w-[1300px] w-full px-6 pt-10 pb-12 relative z-10 flex flex-col">
          ...
          <div className="relative w-full overflow-hidden h-[350px] mt-12 flex justify-center items-start z-10">
            <div className="relative w-full max-w-[260px] aspect-[1/2] translate-y-[20px] transition-transform duration-700 hover:scale-[1.02]">
              <Image
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl w-full mx-auto mt-[-100px] relative z-20 translate-y-1/2">
            {[
